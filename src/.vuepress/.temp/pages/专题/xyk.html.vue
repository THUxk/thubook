...
<p><img src="/assets/image-20240605151546686.png" alt="image-20240605151546686"></p>
<p>背面是清华校园内的标志性建筑和景物为素材进行创作</p>
<p><img src="/assets/image-20240605151626615.png" alt="image-20240605151626615"></p>
<p>校园卡样式由4类三款构成，类型分为<strong>学生证、工作证（在职）、校园卡（离退休）、校园卡</strong>4类，其中工作证（在职）和校园卡（离退休）的卡面款式相同。</p>
<p><img src="/assets/image-20240605151814964.png" alt="image-20240605151814964"></p>
...
<p><img src="/assets/image-20240605144519975.png" alt="image-20240605144519975"></p>
...
<p><strong>无须再进行设备领款</strong>。通过手机端、PC端、自助终端均可进行在线充值，<strong>可以选择银行卡圈存、微信、支付宝多种充值方式</strong>，一秒到账，即时消费。</p>
<p><img src="/assets/image-20240605144800574.png" alt="image-20240605144800574"></p>
...
<p><img src="/assets/image-20240605144841701.png" alt="image-20240605144841701"></p>
<p><img src="/assets/image-20240605144937846.png" alt="image-20240605144937846"></p>
<h3 id="限额修改" tabindex="-1"><a class="header-anchor" href="#限额修改" aria-hidden="true">#</a> 限额修改</h3>
<p><img src="/assets/image-20240605145004448.png" alt="image-20240605145004448"></p>
<h3 id="交易记录查询" tabindex="-1"><a class="header-anchor" href="#交易记录查询" aria-hidden="true">#</a> 交易记录查询</h3>
<p><img src="/assets/image-20240605145030456.png" alt="image-20240605145030456"></p>
<h3 id="信息查询" tabindex="-1"><a class="header-anchor" href="#信息查询" aria-hidden="true">#</a> 信息查询</h3>
<p><img src="/assets/image-20240605145047982.png" alt="image-20240605145047982"></p>
<h3 id="密码修改" tabindex="-1"><a class="header-anchor" href="#密码修改" aria-hidden="true">#</a> 密码修改</h3>
<p><img src="/assets/image-20240605145122120.png" alt="image-20240605145122120"></p>
<h3 id="遗失卡查询" tabindex="-1"><a class="header-anchor" href="#遗失卡查询" aria-hidden="true">#</a> 遗失卡查询</h3>
<p><img src="/assets/image-20240605145152040.png" alt="image-20240605145152040"></p>
<h3 id="自助使用" tabindex="-1"><a class="header-anchor" href="#自助使用" aria-hidden="true">#</a> 自助使用</h3>
<ul>
<li>
<p><strong>自助服务机</strong>：自助服务机支持校园卡或身份证登录，需读取卡片并输入校园卡密码（PIN）认证。挂失、补卡、换卡等特殊情况可输入校园卡号代替读取校园卡。</p>
</li>
<li>
<p><strong>自助服务机位置及服务时间：</strong></p>
</li>
</ul>
<p><img src="/assets/image-20240605153852631.png" alt="image-20240605153852631"></p>
<p>特别提示：自助服务机支持的补卡类型不同，请根据所持校园卡类别选择。其他服务内容相同。</p>
<ul>
<li><strong>服务内容或功能</strong></li>
</ul>
<p><img src="/assets/image-20240605153908761.png" alt="image-20240605153908761"></p>
<p>新版校园卡采用在线账户联机交易模式，可通过微信小程序、综合服务网站、自助服务机进行在线充值，金额实时到账，无需到自助设备领款。</p>
<ul>
<li><strong>人工服务</strong></li>
</ul>
<p><img src="/assets/image-20240605153930237.png" alt="image-20240605153930237"></p>
<p>注意：服务时间不包括法定节假日，寒暑假期间另行通知。</p>
<hr>
<p><em>上次修改时间：2024-6-12</em>
<em>贡献者：计37陈筱涵，计76林慎吾</em></p>
</div></template>
